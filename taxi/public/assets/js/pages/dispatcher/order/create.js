...
function addTaxiMarkers(marker_data){
    ...
    if(marker_data.banned_taxi_status == '1'){
        ...
        if (marker_data.order_status == null) {
            ...
            switch (marker_data.order_status) {
                case '2':
                    imageType = 'taxi_pin_cyan.png';//accepeted
                    break;
                case '3':
                    imageType = 'taxi_pin_cyan.png';//reached
                    break;
                case '8':
    ...
    var contentString = marker_data.phone+' - '+marker_data.number+' - '+marker_data.code;
...
$.getScript("https://maps.googleapis.com/maps/api/js?key=AIzaSyDuCnsHiIEhju6pKTT8tYIP6zlvTybS3yE&callback=initialize")
