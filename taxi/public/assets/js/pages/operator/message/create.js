        ...
        if(keyCode!=38&&keyCode!=40&&keyCode!=13){
            ...
            if (text.length > 0) {
                if(allowRequest) {
                    ...
                    if(destination_type == 1){var url = 'http://ulduz.smarttaxi.cloud/api/track/getTaxiByCode';}
                    else if(destination_type == 2){var url = 'http://ulduz.smarttaxi.cloud/api/track/getCustomerByPhone';}
                    if(destination_type == 1 || destination_type == 2){
                            $.ajax({
                            type: 'get',
                            url: url,
                            data: {
                            ...
                            success: function (data) {
                                ...
                                if(destination_type == 1){
                                    ...
                                    if (len > 0) {
                                        for (var i = 0; i < len; i++) {
                                            if(data['taxies'][i]["fcm_registered_id"] != "" && data['taxies'][i]["action"] == '1'){
