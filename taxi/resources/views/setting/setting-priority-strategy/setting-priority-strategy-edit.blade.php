                    ...
                    <div class="panel panel-white">
                        ...
                        <div class="panel-body">
                            ...
                            @if ($errors->any())
                                ...
                                @endforeach
                            @endif
                           <form action="{{ route('postSettingPriorityStrategyEdit',['id' => $result->id??0,'code' => $module->code]) }}" class="form-horizontal" method="post" accept-charset="utf-8">
                            @csrf
                            <fieldset class="content-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="priority" type="number" class="form-control" value="{{ $result->priority??'' }}" placeholder = "Prioritet">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <select name="payment_method" class="select-fixed-single destinationType">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <select name="important" class="select-fixed-single destinationType">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            ...
                                            <input name = "from_time" type="text" class="form-control" id="anytime-time" value="{{ $result->from_time??'' }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="icon-watch2"></i></span>
                                            <input name= "to_time" type="text" class="form-control" id="anytime-time1" value="{{ $result->to_time??'' }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <select name="status" class="select-fixed-single destinationType">
