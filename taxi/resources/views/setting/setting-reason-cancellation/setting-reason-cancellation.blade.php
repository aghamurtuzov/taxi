            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h5 class="panel-title">Ləğv etmə səbəbi yarat</h5>
                            </div>
                            ...
                            <div class="panel-body">
                                ...
                                @endif
                                <form
                                    action="{{ route('postSettingReasonCancellationEdit',['id' => 0,'code' => $module->code]) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <select name="status" class="select">
                                                    ...
                                                    <option @if(old('status') == 0) selected @endif value="0">Deaktiv
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h5 class="panel-title">Ləğv etmə səbəbləri</h5>
                            </div>
                            <form
                                action="{{ route('getModuleSearch',['code'=> $module->code,'viewMain' => 'setting','view'=>'setting-reason-cancellation.setting-reason-cancellation' ]) }}"
                                ...
                                <div class="panel-body">
                                    ...
                                    <div>
                                        <table class="table table-bordered table-striped table-hover">
                                            ...
                                            <tr>
                                                <th>
                                                    <a href="{{ Url('module/search/'.$module->code.'/setting/setting-reason-cancellation.setting-reason-cancellation') }}?_token={{ csrf_token() }}&name={{ request()->get('name') }}&status={{ request()->get('status') }}&column_name=name&order_type={{ request()->get('order_type') == 'asc' ? 'desc' : 'asc' }}&perPage={{ request()->get('perPage') }}">
                                                        <i class="@if( request()->get('column_name') == 'name') sort-amount-up icon-sort-amount-desc @endif"></i>
                                                        Ad</a></th>
                                                <th>
                                                    <a href="{{ Url('module/search/'.$module->code.'/setting/setting-reason-cancellation.setting-reason-cancellation') }}?_token={{ csrf_token() }}&name={{ request()->get('name') }}&status={{ request()->get('status') }}&column_name=sort&order_type={{ request()->get('order_type') == 'asc' ? 'desc' : 'asc' }}&perPage={{ request()->get('perPage') }}">
                                                        <i class="@if( request()->get('column_name') == 'sort') sort-amount-up icon-sort-amount-desc @endif"></i>
                                                        Sıralama</a></th>
                                                <th>
                                                    <a href="{{ Url('module/search/'.$module->code.'/setting/setting-reason-cancellation.setting-reason-cancellation') }}?_token={{ csrf_token() }}&name={{ request()->get('name') }}&status={{ request()->get('status') }}&column_name=status&order_type={{ request()->get('order_type') == 'asc' ? 'desc' : 'asc' }}&perPage={{ request()->get('perPage') }}">
                                            ...
                                            @foreach($results as $result)
                                                <tr>
                                                    <td>{{$result->name}}</td>
                                                    <td><span
                                                            class="badge badge-flat badge-primary text-primary-600">{{$result->sort}}</span>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a class="btn btn-default"
                                                               href="{{ route('getSettingReasonCancellationEdit',['id' => $result->id,'code' => $module->code]) }}"><i
