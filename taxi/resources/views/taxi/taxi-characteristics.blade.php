            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h5 class="panel-title">Xüsusiyyət Yarat</h5>
                            </div>
                            ...
                            <div class="panel-body">
                                ...
                                @if ($errors->any())
                                    ...
                                    @endforeach
                                @endif
                                <form action="{{ route('postTaxiCharacteristicsEdit',['id' => 0,'code' => $module->code]) }}" class="form-horizontal"
                                    ...
                                    <fieldset class="content-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input name="sort" type="text" class="form-control" value="{{ old('sort') }}"
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h5 class="panel-title">Xüsusiyyətlər</h5>
                            </div>
                            <form action="{{ route('getModuleSearch',['code'=> $module->code,'viewMain' => 'taxi','view'=>'taxi-characteristics' ]) }}"
                                ...
                                <div class="panel-body">
                                    ...
                                    <div>
                                        <table class="table table-bordered table-striped table-hover">
                                            ...
                                            <tr>
                                                <th>
                                                    <a href="{{ Url('module/search/'.$module->code.'/'.'taxi'.'/'.'taxi-characteristics') }}?_token={{ csrf_token() }}
                                                ...
                                                <th>
                                                    <a href="{{ Url('module/search/'.$module->code.'/'.'taxi'.'/'.'taxi-characteristics') }}?_token={{ csrf_token() }}
                                                            ...
                                                            &order_type={{ request()->get('order_type') == 'asc' ? 'desc' : 'asc' }}
                                                            &perPage={{ request()->get('perPage') }}">
                                                        <i class="@if( request()->get('column_name') == 'note') sort-amount-up icon-sort-amount-desc @endif"></i>
                                                        Qeyd</a></th>
                                                <th>
                                                    <a href="{{ Url('module/search/'.$module->code.'/'.'taxi'.'/'.'taxi-characteristics') }}?_token={{ csrf_token() }}
                                                            &name={{ request()->get('name') }}
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a class="btn btn-default"
                                                               href="{{ route('getTaxiCharacteristicsEdit',['id' => $result->id,'module' => 'ut_options']) }}"><i
                                                                        class="icon-pencil7"></i></a>
                                                            <button type="button" class="btn btn-default deleteModal"
                                                                    data-id="{{ $result->id }}" data-code="{{ $module->code }}"><i
