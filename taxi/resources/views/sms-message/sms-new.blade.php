                        ...
                        <div class="panel panel-white">
                            ...
                            <div class="panel-body">
                                ...
                                @if ($errors->any())
                                    ...
                                    @endforeach
                                @endif
                                <form action="{{ route('postSmsEdit',['code' => $module->code]) }}"
                                    ...
                                    <fieldset class="content-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <select @if($result['destination_type']??'') disabled
                                                    ...
                                                    <option @if(isset($result['destination_type']) && $result['destination_type'] == 1) selected
                                                            @endif value="1">Taksi
                                                    </option>
                                                    <option @if(isset($result['destination_type']) && $result['destination_type'] == 2) selected
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <select name="message" class="select-fixed-single smsTemplate">
