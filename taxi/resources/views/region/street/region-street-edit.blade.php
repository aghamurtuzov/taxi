                    ...
                    <div class="panel panel-white">
                        ...
                        <div class="panel-body">
                            ...
                            @if ($errors->any())
                                ...
                                @endforeach
                            @endif
                         <form action="{{ route('postRegionStreetEdit',['id' => $result->id??0,'code' => $module->code]) }}" class="form-horizontal" method="post" accept-charset="utf-8">
                            @csrf
                            <fieldset class="content-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <select name="region" class="select-search">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="keyword" type="text" class="form-control" value="{{$result->keyword??''}}" placeholder="Açar söz">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-lg-2">Prioritet</label>
                                    <div class="col-lg-10">
                                        <input name="priority" type="text" class="form-control" value="{{$result->priority??''}}" placeholder="Prioritet">
                                    </div>
                                </div>
                                <div class="form-group">
