                ...
                <div class="col-md-12">
                    <div class="panel panel-white">
                        <div class="panel-heading">
                            <h5 class="panel-title">Xüsusi Obyekt kateqoriyası redaktə et</h5>
                        </div>
                        ...
                        <div class="panel-body">
                            @if(Session::has('success-message'))
                                ...
                                @if ($errors->any())
                                    ...
                                    @endforeach
                                @endif
                            <form action="{{ route('postRegionSpecialObjectCategoryEdit',['id' => $result->id,'code' => $module->code]) }}" class="form-horizontal" method="post" accept-charset="utf-8">
                                @csrf
