            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h5 class="panel-title">Ölkə yarat</h5>
                            </div>
                            ...
                            <div class="panel-body">
                                ...
                                @if ($errors->any())
                                    ...
                                    @endforeach
                                @endif
                                <form action="{{ route('postRegionCountryEdit',['id' => 0,'code' => $module->code]) }}" class="form-horizontal" method="post" accept-charset="utf-8">
                                    @csrf
                                    <fieldset class="content-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input name="code" type="text" class="form-control" value="{{ old('code') }}" placeholder="Kod">
                                            </div>
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h5 class="panel-title">Ölkələr</h5>
                            </div>
                            <form action="{{ route('getModuleSearch',['code'=> $module->code,'viewMain' => 'region','view'=>'country.region-country' ]) }}" name="listForm" method="get" accept-charset="utf-8">
                                @csrf
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="text" name="name" value="{{request()->input('name')}}" class="form-control" placeholder="Azərbaycan">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="text" name="code" value="{{request()->input('code')}}" class="form-control" placeholder="AZ">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <div>
                                        <table class="table table-bordered table-striped table-hover">
                                            ...
                                            <tr>
                                                <th>
                                                 <a href="{{ Url('module/search/'.$module->code.'/region/country.region-country') }}?_token={{ csrf_token() }}&name={{ request()->get('name') }}&code={{ request()->get('code')}}&status={{ request()->get('status') }}&column_name=name&order_type={{ request()->get('order_type') == 'asc' ? 'desc' : 'asc' }}&perPage={{ request()->get('perPage') }}">
                                                <i class="@if( request()->get('column_name') == 'name') sort-amount-up icon-sort-amount-desc @endif"></i>
                                                 Ad</a>
                                                </th>
                                                <th>
                                                    <a href="{{ Url('module/search/'.$module->code.'/region/country.region-country') }}?_token={{ csrf_token() }}&name={{ request()->get('name') }}&code={{ request()->get('code')}}&status={{ request()->get('status') }}&column_name=code&order_type={{ request()->get('order_type') == 'asc' ? 'desc' : 'asc' }}&perPage={{ request()->get('perPage') }}"><i class="@if( request()->get('column_name') == 'code') sort-amount-up icon-sort-amount-desc @endif"></i>
                                                                                                Kod
                                                                                            </a>
                                                </th>
                                                <th>
                                                    <a href="{{ Url('module/search/'.$module->code.'/region/country.region-country') }}?_token={{ csrf_token() }}&name={{ request()->get('name') }}&code={{ request()->get('code')}}&status={{ request()->get('status') }}&column_name=sort&order_type={{ request()->get('order_type') == 'asc' ? 'desc' : 'asc' }}&perPage={{ request()->get('perPage') }}">
                                                        <i class="@if( request()->get('column_name') == 'sort') sort-amount-up icon-sort-amount-desc @endif"></i>
                                                        Sıralama
                                                    </a>
                                                </th>
                                                <th>
                                                    <a href="{{ Url('module/search/'.$module->code.'/region/country.region-country') }}?_token={{ csrf_token() }}&name={{ request()->get('name') }}&code={{ request()->get('code')}}&status={{ request()->get('status') }}&column_name=status&order_type={{ request()->get('order_type') == 'asc' ? 'desc' : 'asc' }}&perPage={{ request()->get('perPage') }}">
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                       <a class="btn btn-default"
                                                               href="{{ route('getRegionCountryEdit',['id' => $result->id,'code' => $module->code]) }}"><i
